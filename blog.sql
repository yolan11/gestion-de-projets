...
--
-- Host: localhost:3306
-- Generation Time: Apr 14, 2023 at 11:09 AM
...
--
ALTER TABLE `articles`
  ADD CONSTRAINT `articles_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `comments`
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_articles` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`),
